...
export default function Team(): JSX.Element {
  return (
    ...
    >
      ...
      <div className="absolute h-[90%] w-[90%] rounded-lg bg-blue-800 opacity-90 brightness-75 duration-700 ease-in-out group-hover:brightness-110" />
      <div className="absolute h-[55%] w-[65%] rounded-full bg-blue-700 opacity-40 shadow-2xl shadow-blue-800 blur-3xl brightness-110 duration-700 ease-in-out" />

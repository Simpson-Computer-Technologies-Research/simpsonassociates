  ...
  return (
    ...
    >
      <Image
        ...
        height={1080}
        loading="eager"
        className="absolute h-[90%] w-[90%] rounded-lg duration-700 ease-in-out group-hover:brightness-110"
      />

      {/* Image blue overlay color and text over image */}
      <div className="absolute h-[90%] w-[90%] rounded-lg bg-[#0048ff] opacity-[0.75] duration-700 ease-in-out"></div>
      <div className="absolute h-full left-0 w-1/2 rounded-full bg-[#21b5ff] bg-gradient-to-r from-[#5fcaff] to-[#0048ff] opacity-20 shadow-2xl shadow-blue-700 blur-3xl duration-700 ease-in-out"></div>

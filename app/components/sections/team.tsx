...
export default function Team(): JSX.Element {
  return (
    ...
    >
      ...
      <div className="absolute left-0 h-full w-1/2 rounded-full bg-[#21b5ff] bg-gradient-to-r from-[#5fcaff] to-[#0048ff] opacity-20 shadow-2xl shadow-blue-700 blur-3xl duration-700 ease-in-out"></div>

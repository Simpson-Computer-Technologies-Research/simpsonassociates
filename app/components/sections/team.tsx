...
export default function Team(): JSX.Element {
  return (
    ...
    >
      ...
      />
      {/* Image blue overlay color */}
      <div className="absolute h-[90%] w-[90%] rounded-lg bg-blue-700 opacity-80 brightness-75 duration-700 ease-in-out group-hover:brightness-110" />
      <div className="absolute h-1/2 w-1/2 rounded-full bg-blue-600 opacity-30 blur-3xl brightness-110 duration-700 ease-in-out" />
      ...
      <div className="flex h-0 w-20 -translate-x-full flex-row gap-2 fill-secondary opacity-0 duration-700 ease-in-out group-hover:h-20 group-hover:translate-x-0 group-hover:opacity-100 sm:w-32 sm:group-hover:h-32 md:w-40 md:group-hover:h-40 lg:w-52 lg:group-hover:h-52">
        <svg
          ...
          className="z-10 duration-100 ease-in-out group-hover:rotate-180"
        >
          <g>

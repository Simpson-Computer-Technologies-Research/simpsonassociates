...
export default function Testimonials(): JSX.Element {
  ...
  return (
    <section
      id="testimonials"
      className="group relative flex w-full flex-col items-center justify-center bg-gray-50 pb-12 pt-16 md:pb-16 md:pt-20"
    >
      <Header />
...
const TestimonialCard = (props: { testimonial: any }) => (
  <span className="mx-1 flex w-80 flex-col items-center rounded-xl border-2 border-gray-50 p-4 text-center duration-500 ease-in-out hover:duration-0 xs:mx-3 md:mx-5 md:w-96 lg:w-[30rem]">
    {" "}
